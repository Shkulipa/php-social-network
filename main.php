...
<body>
    ...
    <div class="row">
        <div class="col-sm-6" style="left: .5%">
            <img src="images/codingcafe2.jpg" alt="" class="img-rounded" title="Coding cafe" width="650px" height="565px">
        ...
        <div class="col-sm-6" style="left: 8%">
            <img src="images/codingcafelogo.png" alt="" class="img-rounded" title="Coding cafe" width="80px" height="80px">
